...
**Hello React Frontend** In this project I am going to use an API created with <a href="https://github.com/Cisco-the-wayword/hello-rails-backend">hello-rails-backend</a> app.
...
```sh
  cd my-folder
  git clone https://github.com/Cisco-the-wayword/hello-react-frontend.git
```
